...
public class NumBiggerThen implements MatchOperation<Number> {
    public static NumBiggerThen getInstance(){
        return new NumBiggerThen();
    }
    ...
    public boolean equals(Object o) {
        ...
        NumBiggerThen that = (NumBiggerThen) o;
